...
import { removeUserSession } from '../../vrspages/Common/Common';
...
export function Header() {
  ...
  const handleLogout = (e) => { 
    ...
    removeUserSession();
    console.log("handlelogout use statement called")
     // removeUserSession();  
      ...
      <Container fluid className="main-container">
        <div className="d-flex align-items-center">
          ...
          <div className="responsive-logo">
            ...
            >
              <img
                src={require("../../assets/images/brand/logom-3.png")}
                className="mobile-logo logo-1"
                alt="logo"
              />
              <img
                src={require("../../assets/images/brand/logom.png")}
                 ...
                 {/*    <div className="dropdown-menu header-search dropdown-menu-start">
                  ...
                  <Dropdown className=" d-md-flex profile-1">
                    <Dropdown.Toggle
                      ...
                      variant=""
                    >
                      <span className="media-icon bg-success me-3 mt-1">
                      <i className="fe fe-user  fs-20 text-white"></i>
                      {/* <i className="dropdown-icon fe fe-user" style={{marginLeft:"7px"}}></i> */}
                        {/* <img
                    ...
                    >
                      <div className="drop-heading">
                        <div className="text-center">
                          <h5 className="text-dark mb-0">{localStorage.getItem("name")}</h5>
                          {/* <small className="text-muted">Software Agency</small> */}
                        </div>
                      </div>
                      <div className="dropdown-divider m-0"></div>
                      {/* <Dropdown.Item
