...
import * as dashboard from "../../data/dashboard/vendashboard";
...
export default function Dashboard() { 
    ...
    <div>
      <div className="page-header ">
        <div>
          <h1 className="page-title">Welcome to the PHED Vendor Approval System</h1>
            ...
            <Col lg={6} md={12} sm={12} xl={3}>
              <Card className=" overflow-hidden">
                <Card.Body className="card-body">
                  <Row>
                    <div className="col">
                      <h6 className="">Total Application</h6>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12 col-xl-3">
              <div className="card overflow-hidden">
                <div className="card-body">
                  <Row>
                    <div className="col">
                      <h6 className="">Total Approved</h6>
                      <h3 className="mb-2 number-font">
                        <CountUp
                          end={1}
                          separator=","
            ...
            <Col lg={6} md={12} sm={12} xl={3}>
              <Card className=" overflow-hidden">
                <Card.Body className="card-body">
                  <Row>
                    <div className="col">
                      <h6 className="">Total Canceled</h6>
                      <h3 className="mb-2 number-font">
     ...
     {/*  <Row>
      ...
      <Row>
        <Col sm={12} className="col-12">
          <Card>
            <Card.Header>
              <h3 className="card-title mb-0">Application Status</h3>
            </Card.Header>
            <Card.Body>
              <div className="salesdatatable">
                <div className="table-responsive">
                  <dashboard.DashbordTable />
