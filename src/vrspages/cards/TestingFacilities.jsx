	...
	const update_test = async (e) => {
		...
		if(info && mode === 2){
			await axios.put(process.env.REACT_APP_BASE_URL + "/api/v1/TestingInfoDetails", data).then((res) => {
				...
				else setTestingMsg("Something went wrong")
			}).catch((err) => {
		...
		for (let i = 0; i < files.length; i++) {
			...
			await axios.post(process.env.REACT_APP_BASE_URL + "/common/filemgr", formData).then((res) => {
				if (res.data.code === 0) {
					...
					setTestingMsg("Something went wrong while uploading file")
				}
									...
									Institution?<select value={info_obj?.inHouseTestFlag} disabled={mode === 1} onChange={(e) => set_info_obj({ ...info_obj, inHouseTestFlag: e.target.value })} id='inHouseTestFlag' className='yesno'><option value={"N"}>No</option><option value={"Y"}>Yes</option></select></p>
								{
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
														...
														<CancelOutlinedIcon onClick={(e) => delete_file(e, i, "09")} className='cross-icon' id='categoryOfUnit' name="testlab" />
													</div>
												))
											}
										</>)
											...
											{mode !== 1 && <tr>
												...
												<td>
													<input onChange={handleTableInputChange}
														value={testingTable.testName} className='form-control' type='text' name='testName' />
												</td>
												<td>
													<input onChange={handleTableInputChange}
														value={testingTable.testFrequency} className='form-control' type='text' name='testFrequency' />
												</td>
												<td>
													<input onChange={handleTableInputChange}
														value={testingTable.testEquip} className='form-control' type='text' name='testEquip' />
												</td>
												<td>
													<input onChange={handleTableInputChange}
														value={testingTable.noOfTest} className='form-control' type='number' name='noOfTest' />
												</td>
												<td>
													<input onChange={handleTableInputChange}
														value={testingTable.makeYear} className='form-control' type='number' name='makeYear' />
												</td>
												<td>
													<input onChange={handleTableInputChange}
														value={testingTable.validityOfCalibration} className='form-control' type='text' name='validityOfCalibration' />
												</td>
												<td>
											...
											</tr>}
											{
												testingTableRow.map((item, index) => (
													<tr key={index}>
														...
														{mode !== 1 && <td>
															<button onClick={e => removeTestingTableRow(index)}>
								...
								<div className="col-md-4">
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
																...
																<CancelOutlinedIcon onClick={(e) => delete_file(e, i, "10")} className='cross-icon' id='categoryOfUnit' name="outsrclab" />
															</div>
														))
													}
												</>)
											...
											{mode !== 1 && <tr>
												...
												<td>
													<input onChange={handleTableInputChange2}
														value={testingTable2.testlab} className='form-control' type='text' name='testlab' />
												</td>
												<td>
													<input onChange={handleTableInputChange2}
														value={testingTable2.testlabAddress} className='form-control' type='text' name='testlabAddress' />
												</td>
												<td>
													<input onChange={handleTableInputChange2}
														value={testingTable2.testName} className='form-control' type='text' name='testName' />
												</td>
												<td>
													<input onChange={handleTableInputChange2}
														value={testingTable2.testFrequency} className='form-control' type='text' name='testFrequency' />
												</td>
												<td>
													<input onChange={handleTableInputChange2}
														value={testingTable2.noOfTest} className='form-control' type='number' name='noOfTest' />
												</td>
												<td>
													<input onChange={handleTableInputChange2}
														value={testingTable2.validityOfCalibration} className='form-control' type='text' name='validityOfCalibration' />
												</td>
												<td>
											...
											</tr>}
											{
												testingTableRow2.map((item, index) => (
													<tr key={index}>
														...
														<td>{item.validityOfCalibration}</td>
														{mode !== 1 && <td>
															<button onClick={e => removeTestingTableRow2(index)}>
																<i className="fa-regular fa-trash-can"></i>
															</button>
														</td>}
													</tr>
								...
								{info_obj.systemOfNCR === "Y" && <div className='col-md-5'>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
											...
											<CancelOutlinedIcon  onClick={(e)=>showFileInput("systemOfNCR")}   className='cross-icon' id='categoryOfUnit'  />
											</div>
										)):
										<div  
								...
								{info_obj.systemOfdentification === "Y" &&
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
											...
											<CancelOutlinedIcon  onClick={(e)=>showFileInput("systemOfdentification")}   className='cross-icon' id='categoryOfUnit'  />
											</div>
										)):
								...
								{info_obj.stiFlag === "Y" &&
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
											...
											<CancelOutlinedIcon  onClick={(e)=>showFileInput("stiFlag")}   className='cross-icon' id='categoryOfUnit'  />
											</div>
										)):
								...
								<div className='col-md-5'>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
											...
											<CancelOutlinedIcon  onClick={(e)=>showFileInput("bisLicenseNo")}   className='cross-icon' id='categoryOfUnit'  />
											</div>
										)):
								...
								{info_obj.isoCertificate9001 === "Y" && <div className='col-md-5'>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
											...
											<CancelOutlinedIcon  onClick={(e)=>showFileInput("isoCertificate9001")}   className='cross-icon' id='categoryOfUnit'  />
											</div>
										)):
								...
								{info_obj.isoCertificate17025 === "Y" &&
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
											...
											<CancelOutlinedIcon  onClick={(e)=>showFileInput("isoCertificate17025")}   className='cross-icon' id='categoryOfUnit'  />
											</div>
										)):
