...
<label for="MR_file"><i className="fa fa-solid fa-arrow-up-from-bracket"></i> Add file</label>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
										...
										<CancelOutlinedIcon onClick={(e)=>delete_file(e, i, "06")}  className='cross-icon' id='categoryOfUnit'  />
										</div>
									))
										}
									</>
...
<label for="AM_file"><i className="fa fa-solid fa-arrow-up-from-bracket"></i> Add file</label>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
										...
										<CancelOutlinedIcon onClick={(e)=>delete_file(e, i, "07")}   className='cross-icon' id='categoryOfUnit'  />
										</div>
									))
										}
									</>
...
<label for="DE_file"><i className="fa fa-solid fa-arrow-up-from-bracket"></i> Add file</label>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
										...
										<CancelOutlinedIcon onClick={(e)=>delete_file(e, i, "08")}  className='cross-icon' id='categoryOfUnit'  />
										</div>
									))
										}
									</>
