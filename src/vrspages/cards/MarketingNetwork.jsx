...
function MarketingNetwork({ info, mode }) {
    ...
    return (
        <div className="">
                ...
                <div className="">
                    {mode !== 1 && <div className='col-md-12 text-right'><button className="addtag contact-btn ml-0" onClick={addMoreMarketingNetworkRow}><i className="fa fa-plus-circle fsize16" aria-hidden="true"></i> Add</button></div>}
                    <form onSubmit={upldate_MN}>
                        {
                            ...
                            marketingNetwork.map((item, index) => (
                                <div className='row myrow' key={index}>
                                    ...
                                    {mode !== 1 && <div className='col-md-1 pl-0'>
