...
function GeneralInfoCard({ info, disabled, vendorInfo, mode, selectedProduct, setSubmitCond, submitCond}) {
    ...
    const update_GI = async (e)=>{
        ...
        if(mode === 2)
        await axios.put(process.env.REACT_APP_BASE_URL+"/api/v1/generaldetails",putObj).then((res)=>{
            if (res.data.code === 0){
    ...
    return (
                ...
                <form onSubmit={update_GI}>
                    <div className='row'>
                        ...
                        <div className="col-md-4">
                            <div className="from-each-div">
                                <p className="from-label-p">Nature of Company<span className='text-danger fs-5'>*</span></p>
                                  ...
                                  window.open(
                                    ...
                                    "_blank",
                                        ...
                                        <>
                                            {mode===3? check.natureOfCompany?<input required name='natureOfCompany' onChange={handleFileChange} type="file" accept="image/*,.pdf" className="form-control d-inline-block w-auto" />:""
                        ...
                        <div className="col-md-4">
                            <div className="from-each-div">
                                <p className="from-label-p">Category of the Unit<span className='text-danger fs-5'>*</span></p>
