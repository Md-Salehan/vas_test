            ...
            <div>
                <div className="">
                    ...
                    <FormControl sx={{width: "100%"}}>
                        ...
                        {approve === "A" &&  
                        <div>
                        <FormLabel style={{ color: "red"}} id="demo-radio-buttons-group-label">Please give Approval Memo Number And date</FormLabel>
                        <textarea value={reason} onChange={(e)=>setReason(e.target.value)} style={{ minWidth: "100%", minHeight: "100px" }}
                id='rejDtl' placeholder='' className="form-control d-inline-block w-auto align-top courtCases" disabled= {checkStatus==="A" || checkStatus==="R"} /></div>}
                  {approve === "R" && 
                  <div>
                  <FormLabel style={{ color: "red"}} id="demo-radio-buttons-group-label">Please give reason as per decission of the committee. This will be notified to the vendor.</FormLabel>
                  <textarea value={reason} onChange={(e)=>setReason(e.target.value)} style={{ minWidth: "100%", minHeight: "100px" }}
                id='rejDtl' placeholder='' className="form-control d-inline-block w-auto align-top courtCases" disabled= {checkStatus==="A" || checkStatus==="R"}/></div>}
