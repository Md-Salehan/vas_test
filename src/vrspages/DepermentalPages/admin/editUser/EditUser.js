  ...
  const handleRegistration= async ()=>
      {
        ...
        landlineNo: ''
          ...
          setLoading(true);
          await axios.put(process.env.REACT_APP_BASE_URL+'/api/v1/registrationdetails', vendorObj).then(res => {
              ...
              if(res.data.code === 0) 
              {
                  alert("Registered Update successfully");
          useremailid.value='';			
          nameofUser.value='';
              userType.value='';
        usermobileno.value='';
        ...
        <div className='right-pannel-div'>
          <div className='right-pannel-div-inner mrgin-buttom-zero'>
            ...
            <div className='col-md-12'>
                              <table class="mt-5 bg-white table w-100 table-bordered ">
